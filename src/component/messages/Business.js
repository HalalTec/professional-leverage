...
const Business = ({close, msg, submit}) => {
    const [currentIndex, setCurrentIndex] = useState(msg)

    const bands = {
        '1-3': {
            title: 'A 1–3 in Signature Strength Recognition often looks like:',
            bullets: [
                'You may not know your strongest repeat strengths.',
                'What comes easy may not feel valuable.',
                'Your best abilities may still be hard to spot.'
            ]
        },
        '4-6': {
            title: 'A 4–6 in Signature Strength Recognition often looks like:',
            bullets: [
                'You know some strengths, but not the full pattern.',
                'Some key strengths still feel too normal.',
                'You may be missing your biggest advantages.'
            ]
        },
        '7-8': {
            title: 'A 7–8 in Signature Strength Recognition often looks like:',
            bullets: [
                'Your strengths are mostly clear.',
                'Some familiar strengths may still be easy to overlook.',
                'There may still be hidden strengths in plain sight.'
            ]
        },
        '9-10': {
            title: 'A 9–10 in Signature Strength Recognition often looks like:',
            bullets: [
                'You know your strongest abilities well.',
                'You can spot your strengths fast.',
                'You know what keeps driving your best results.'
            ]
        }
    };
