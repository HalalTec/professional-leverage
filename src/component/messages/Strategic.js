...
const Strategic = ({close, msg, submit}) => {
    const [currentIndex, setCurrentIndex] = useState(msg)

    const bands = {
        '1-3': {
            title: 'A 1–3 in Value Articulation often looks like:',
            bullets: [
                'It is hard to explain what you really bring.',
                'People may not quickly see your strongest value.',
                'Your message may feel vague.'
            ]
        },
        '4-6': {
            title: 'A 4–6 in Value Articulation often looks like:',
            bullets: [
                'You can explain your value, but it takes time.',
                'Your message is not always sharp enough.',
                'People need extra time to understand your best value.'
            ]
        },
        '7-8': {
            title: 'A 7–8 in Value Articulation often looks like:',
            bullets: [
                'Your value is mostly clear.',
                'You explain yourself well, but it could be tighter.',
                'Some parts of your message still need sharpening.'
            ]
        },
        '9-10': {
            title: 'A 9–10 in Value Articulation often looks like:',
            bullets: [
                'People quickly understand your value.',
                'Your message is easy to explain.',
                'What you bring feels clear and strong.'
            ]
        }
    };
